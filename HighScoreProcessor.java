...
public class HighScoreProcessor implements Runnable {
   ...
   // local copy of highScores - used if highScores cant be read from a file.
 ...
 // ------------------------------------------------------------------
  ...
  // ------------------------------------------------------------------------------------
    ...
    public boolean newScoreIsAHighScore(int newScore)  {
        ...
        if (newScore <= lowScore)  return false;  // no need to update high scores
        return true;

    } // end newScoreIsAHighScore(int newScore)
